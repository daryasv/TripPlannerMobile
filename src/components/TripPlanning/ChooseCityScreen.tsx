...
import { GetCities, GetCountries } from "../../actions/tripActions";
import AutocompleteInput from 'react-native-autocomplete-input';
import { Colors } from "../../theme/Colors";

export default function ChooseCityScreen({route}) {

const country = route.params?.selectedValue;
...
const handleSelectItem = (item) => {
  ...
  useEffect(() => {
    GetCities(country, (success) => {
      if (success) {
        setFullOptions(success.data);
      }
    });
  }, []);
  ...
  return (
    <View style={styles.iphone1313Pro7}>
      ...
      <View style={styles.whereAreYouTravelingParent}>
        <Text style={styles.planATripTypo}>Where in {country}?</Text>
        <AutocompleteInput
            data={options}
            defaultValue={query}
      ...
      />
        ...
        <Button
          ...
          onPress={() => navigation.navigate("ChooseDaysScreen", {selectedValue, key})}
